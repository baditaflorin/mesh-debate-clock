...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-debate-clock-ff6464)](https://baditaflorin.github.io/mesh-debate-clock/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-debate-clock/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> PRO vs CON, alternating 60-second turns, mesh-clocked.

**Live → https://baditaflorin.github.io/mesh-debate-clock/**

**Source → https://github.com/baditaflorin/mesh-debate-clock**
...
git clone https://github.com/baditaflorin/mesh-debate-clock
cd mesh-debate-clock
npm install
npm run dev
```
...
- `mesh-debate-clock:signalingUrl`
- `mesh-debate-clock:turnTokenUrl`
- `mesh-debate-clock:iceServers`
- `mesh-debate-clock:room`
